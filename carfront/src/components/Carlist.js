...
class Carlist extends Component {
    ...
    addCar(car) {
        ...
        apm.addTags(car);
        const span1 = transaction.startSpan('My custom span 1')
        fetch(SERVER_URL + 'api/cars',
            ...
            .then(res => this.fetchCars(), span1.end())
            .catch(err => console.error(err), span1.end(),transaction.end())
    }

    fetchCars = () => {
        var transaction = apm.getCurrentTransaction()
        var span2 = transaction.startSpan('My custom span 2')
        fetch(SERVER_URL + 'api/cars')
    ...
    // Update car
    updateCar(car, link) {
        var transaction = apm.startTransaction("Update Car", "Car");
        apm.addTags(car);
        transaction.addLabels({ "carname": car.model })
        var span1 = transaction.startSpan('My custom span 1')
        fetch(link,
            {
                method: 'PUT',
                headers: {
